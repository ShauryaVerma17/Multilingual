...
firstClientLanguage = (conn1.recv(2048)).decode()
print(addr1, ' has connected to the server with the following language : ', firstClientLanguage)
conn2, addr2 = s.accept()
secondClientLanguage = (conn2.recv(2048)).decode()
print(addr2, ' has connected to the server with the following language : ', secondClientLanguage)
